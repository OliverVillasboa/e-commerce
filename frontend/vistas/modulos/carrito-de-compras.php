		...
		<div class="modal-body modalTitulo">
			...
			<div class="contenidoCheckout">
				...
				<div class="listaProductos row">
					...
					<div class="col-sm-6 col-xs-12 pull-right">
						...
						<table class="table table-striped tablaTasas">
							...
							<tbody>
								...
								<tr>
									<td>Subtotal</td>	
									<td><span class="cambioDivisa"></span> Gs.<span class="valorSubtotal" valor="0">0</span></td>	
								</tr>

								<tr>
									<td>Envío</td>	
									<td><span class="cambioDivisa"></span> Gs.<span class="valorTotalEnvio" valor="0">0</span></td>	
								</tr>

								<tr>
									<td>Impuesto</td>	
									<td><span class="cambioDivisa"></span> Gs.<span class="valorTotalImpuesto" valor="0">0</span></td>	
								</tr>

								<tr>
									<td><strong>Total</strong></td>	
									<td><strong><span class="cambioDivisa"></span> Gs.<span class="valorTotalCompra" valor="0">0</span></strong></td>	
								</tr>
					...
					<button class="btn btn-block btn-lg btn-default backColor btnPagar">PAGAR PIRA</button>
