...
if(isset($_POST["divisa"])){
	...
	for($i = 0; $i < count($idProductos); $i ++){
		...
		$divisa = file_get_contents("http://free.currencyconverterapi.com/api/v3/convert?q=GS_".$_POST["divisa"]."&compact=y");

		$jsonDivisa = json_decode($divisa, true);

		$conversion = number_format($jsonDivisa["GS_".$_POST["divisa"]]["val"],2);
