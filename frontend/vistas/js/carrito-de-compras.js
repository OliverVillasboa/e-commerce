				...
				$(".cuerpoCarrito").append(
					...
					'<div clas="row itemCarrito">'+
						...
						'<div class="col-md-2 col-sm-1 col-xs-12">'+
							...
							'<p class="precioCarritoCompra text-center">Gs.<span>'+precio+'</span></p>'+
						...
						'<div class="col-md-2 col-sm-1 col-xs-4 text-center">'+
							...
							'<p class="subTotal'+index+' subtotales">'+
								...
								'<strong>Gs.<span>'+(Number(item.cantidad)*Number(precio))+'</span></strong>'+
	...
	if(tipo == "virtual"){
		...
		for(var i = 0; i < seleccionarDetalle.length; i++){
			...
			if($(seleccionarDetalle[i]).val() == ""){
				...
				swal({
					  title: "Debe seleccionar Cantidad y Color",
					  text: "",
					  type: "warning",
...
$(document).on("change", ".cantidadItem", function(){
	...
	$(".subTotal"+item).html('<strong>Gs.<span>'+(cantidad*precio)+'</span></strong>');
...
function sumaSubtotales(){
	...
	$(".sumaSubTotal").html('<strong>Gs. <span>'+(sumaTotal).toFixed(2)+'</span></strong>');
...
function divisas(metodoPago){
	...
	if(metodoPago == "paypal"){
		...
		$("#cambiarDivisa").append('<option value="GS">GS</option>'+
...
$("#cambiarDivisa").change(function(){
	...
	$.ajax({
	    ...
	    success:function(respuesta){
	    	...
	    	var conversion = (respuesta["GS_"+divisa]["val"]).toFixed(2);
