				...
				<?php
					...
					echo '<div class="comprarAhora" style="display:none">
						...
						if($infoproducto["oferta"] == 0){
							...
							<p class="subTotal'.$infoproducto["id"].' subtotales">
								...
								<strong>Gs. <span>'.$infoproducto["precio"].'</span></strong>
							...
							<p class="subTotal'.$infoproducto["id"].' subtotales">
								...
								<strong>Gs. <span>'.$infoproducto["precioOferta"].'</span></strong>
					...
					if($infoproducto["precio"] == 0){
						...
						if($infoproducto["oferta"] == 0){
							...
							echo '<h2 class="text-muted">Gs. '.$infoproducto["precio"].'</h2>';
							...
							echo '<h2 class="text-muted">
								...
								<span>
									...
									<strong class="oferta">Gs. '.$infoproducto["precio"].'</strong>

								</span>

								<span>
									
									Gs.'.$infoproducto["precioOferta"].'
							...
							if($infoproducto["tipo"]=="virtual"){
								...
								echo '<button class="btn btn-default btn-block btn-lg backColor agregarGratis" idProducto="'.$infoproducto["id"].'" idUsuario="'.$_SESSION["id"].'" tipo="'.$infoproducto["tipo"].'" titulo="'.$infoproducto["titulo"].'">SOLICITAR AHORA</button>
									...
									<strong>¡Atención!</strong>
										...
										Debe iniciar sesion para solicitar el producto, no se cobrará los cargos de envío.
							...
							if($infoproducto["oferta"] != 0){
								...
								echo '<button class="btn btn-default btn-block btn-lg backColor agregarGratis" idProducto="'.$infoproducto["id"].'" idUsuario="'.$_SESSION["id"].'" tipo="'.$infoproducto["tipo"].'" titulo="'.$infoproducto["titulo"].'">SOLICITAR AHORA</button>
									...
									<strong>¡Atención!</strong>
										...
										Debera iniciar sesión para hacer la solicitud del producto, una vez solicitado recibirás una llamada de confirmacion del Administrador, no se cobrará los cargos de envío.
							...
							if($value["oferta"] != 0){
								...
								echo '<h2>
										...
										<small>
											...
											<strong class="oferta">Gs. '.$value["precio"].'</strong>

										</small>

										<small>Gs.'.$value["precioOferta"].'</small>
									
									</h2>';

							}else{

								echo '<h2><small>Gs. '.$value["precio"].'</small></h2>';
					...
					<div class="col-sm-6 col-xs-12 pull-right">
						...
						<table class="table table-striped tablaTasas">
							...
							<tbody>
								...
								<tr>
									<td>Subtotal</td>	
									<td><span class="cambioDivisa">Gs.</span> Gs.<span class="valorSubtotal" valor="0">0</span></td>	
								</tr>

								<tr>
									<td>Envío</td>	
									<td><span class="cambioDivisa">Gs.</span> Gs.<span class="valorTotalEnvio" valor="0">0</span></td>	
								</tr>

								<tr>
									<td>Impuesto</td>	
									<td><span class="cambioDivisa">Gs.</span> Gs.<span class="valorTotalImpuesto" valor="0">0</span></td>	
								</tr>

								<tr>
									<td><strong>Total</strong></td>	
									<td><strong><span class="cambioDivisa">Gs.</span> Gs.<span class="valorTotalCompra" valor="0">0</span></strong></td>	
								</tr>
