	...
	<div class="container">
		...
		<div class="row" id="cabezote">
			...
			<div class="col-md-3 col-sm-2 col-xs-12" id="carrito">
				...
				<p>TU CESTA <span class="cantidadCesta"></span> <br> Gs. <span class="sumaCesta"></span></p>	
			...
			<hr>
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="text" class="form-control input-lg" id="regEmail" name="regEmail" placeholder="Telefono" required>
				...
				<div class="checkBox">
					...
					<label>
						...
						<input id="regPoliticas" type="checkbox">
							...
							<a href="https://www.iubenda.com/privacy-policy/84581273" class="iubenda-white iubenda-embed" title="Privacy Policy ">Privacy Policy</a><script type="text/javascript">(function (w,d) {var loader = function () {var s = d.createElement("script"), tag = d.getElementsByTagName("script")[0]; s.src="https://cdn.iubenda.com/iubenda.js"; tag.parentNode.insertBefore(s,tag);}; if(w.addEventListener){w.addEventListener("load", loader, false);}else if(w.attachEvent){w.attachEvent("onload", loader);}else{w.onload = loader;}})(window, document);</script>
			...
			<hr>
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="text" class="form-control input-lg" id="ingEmail" name="ingEmail" placeholder="Numero de Celular" required>
        ...
        <div class="modal-body modalTitulo">
           ...
           <button type="button" class="close" data-dismiss="modal">&times;</button>
			...
			<form method="post">
				...
				<label class="text-muted">Escribe el numero de telefono con el que estás registrado y allí te enviaremos una nueva contraseña:</label>
				...
				<div class="form-group">
					...
					<div class="input-group">
						...
						<input type="text" class="form-control input-lg" id="passEmail" name="passEmail" placeholder="Numero de celular" required>
