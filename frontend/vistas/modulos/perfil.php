										...
										if($value2["oferta"] != 0){
											...
											echo '<h2 style="margin-top:-10px">
													...
													<small>
														...
														<strong class="oferta" style="font-size:12px">Gs. '.$value2["precio"].'</strong>
											...
											echo '<h2 style="margin-top:-10px"><small>Gs. '.$value2["precio"].'</small></h2>';
					...
					<form method="post" enctype="multipart/form-data">
						...
						if($_SESSION["modo"] != "directo"){
							...
							echo '<label class="control-label text-muted text-uppercase">Nombre:</label>
									...
									<label class="control-label text-muted text-uppercase">Numero de Celular:</label>
							...
							echo '<label class="control-label text-muted text-uppercase" for="editarNombre">Cambiar Nombre:</label>
								...
								<label class="control-label text-muted text-uppercase" for="editarEmail">Cambiar Numero de Celular:</label>
