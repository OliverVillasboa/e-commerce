	...
	$.ajax({
		...
		success:function(respuesta){
			...
			if(respuesta == "false"){
				...
				$("#regEmail").parent().before('<div class="alert alert-warning"><strong>ERROR:</strong> El numero de telefono ya existe en la base de datos, fue registrado a través de '+modo+', por favor ingrese otro diferente</div>')
...
function registroUsuario(){
	...
	if(email != ""){
		...
		if(!expresion.test(email)){
			...
			$("#regEmail").parent().before('<div class="alert alert-warning"><strong>ERROR:</strong> Escriba correctamente el numero de celular</div>')
		...
		if(validarEmailRepetido){
			...
			$("#regEmail").parent().before('<div class="alert alert-danger"><strong>ERROR:</strong> El numero de celular ya existe en la base de datos, por favor ingrese otro diferente</div>')
