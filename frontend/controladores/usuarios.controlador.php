...
class ControladorUsuarios{
	...
	public function ctrRegistroUsuario(){
		...
		if(isset($_POST["regUsuario"])){
			...
			if(preg_match('/^[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["regUsuario"]) &&
			   preg_match('/^[a-zA-Z0-9]*$/', $_POST["regEmail"]) &&
			   preg_match('/^[a-zA-Z0-9]+$/', $_POST["regPassword"])){

				$salt = "alskdjflkajsdf46d54fa6s4df6a54fd";
				...
				if($respuesta == "ok"){
					...
					if($envio = true){
						...
						echo '<script> 
							...
							swal({
								  title: "¡OK!",
								  text: "¡Cuenta creada con éxito! '.$_POST["regEmail"].' para verificar la cuenta!",
								  type:"success",
	...
	public function ctrIngresoUsuario(){
		...
		if(isset($_POST["ingEmail"])){
			...
			if(preg_match('/^[a-zA-Z0-9]*$/', $_POST["ingEmail"]) &&
				...
				if($respuesta["email"] == $_POST["ingEmail"] && $respuesta["password"] == $password){
					...
					if($respuesta["verificacion"] == 0){
						...
						echo'<script>
							...
							swal({
								  title: "¡NO HA VERIFICADO SU TELEFONO!",
								  text: "¡Cuenta creada con éxito!'.$respuesta["email"].'!",
								  type: "error",
								  confirmButtonText: "Cerrar",
								  closeOnConfirm: false
							},
					...
					echo'<script>
							...
							swal({
								  ...
								  text: "¡Por favor revise que el telefono exista o la contraseña coincida con la registrada!",
								  type: "error",
								  confirmButtonText: "Cerrar",
								  closeOnConfirm: false
							},
	...
	public function ctrOlvidoPassword(){
		...
		if(isset($_POST["passEmail"])){
			...
			if(preg_match('/^[a-zA-Z0-9]*$/', $_POST["passEmail"])){
				...
				if($respuesta1){
					...
					if($respuesta2  == "ok"){
						...
						date_default_timezone_set("Paraguay/Salto del Guaira");
						...
						$mail->setFrom('oliv.villasboa@gmail.com', 'oliver villasboa');

						$mail->addReplyTo('oliver@gmail.com', 'oliver villasboa');
						...
						$mail->msgHTML('<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">
								...
								<center>
									...
									<img style="padding:20px; width:10%" src="http://www.oliver.villasboa.com/tienda/logo.png">
								...
								<div style="position:relative; margin:auto; width:600px; background:white; padding:20px">
									...
									<img style="padding:20px; width:15%" src="http://www.oliver.villasboa.com/tienda/icon-pass.png">
						...
						if(!$envio){
							...
							echo '<script> 
								...
								swal({
									  title: "¡OK!",
									  text: "¡Cuenta creada con éxito!'.$_POST["passEmail"].' para su cambio de contraseña!",
									  type:"success",
									  confirmButtonText: "Cerrar",
									  closeOnConfirm: false
									},
					...
					echo '<script> 
						...
						swal({
							  title: "¡ERROR!",
							  text: "¡El numero de telefono no existe en el sistema!",
							  type:"error",
							  confirmButtonText: "Cerrar",
							  closeOnConfirm: false
							},
				...
				echo '<script> 
						...
						swal({
							  title: "¡ERROR!",
							  text: "¡Error al enviar el numero de telefono, está mal escrito!",
							  type:"error",
							  confirmButtonText: "Cerrar",
							  closeOnConfirm: false
							},
		...
		if($respuesta0){
			...
			if($respuesta0["modo"] != $datos["modo"]){
				...
				echo '<script> 
						...
						swal({
							  title: "¡ERROR!",
							  text: "¡El numero de telefono  '.$datos["email"].', ya está registrado en el sistema con un método diferente a Google!",
							  type:"error",
							  confirmButtonText: "Cerrar",
							  closeOnConfirm: false
							},
		...
		if(isset($_POST['mensajeContactenos'])){
			...
			preg_match('/^[^0-9][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[@][a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{2,4}$/', $_POST["emailContactenos"])){
				...
				=============================================*/
					...
					$mail->setFrom('oliver.villasboa@gmail.com', 'Imperial Store');

					$mail->addReplyTo('oliver@gmail.com', 'Imperial Store');

					$mail->Subject = "Ha recibido una consulta";

					$mail->addAddress("oliver.villasboa@gmail.com");

					$mail->msgHTML('

						<div style="width:100%; background:#eee; position:relative; font-family:sans-serif; padding-bottom:40px">

						<center><img style="padding:20px; width:10%" src="http://www.oliver.villasboa.com/tienda/logo.png"></center>

						<div style="position:relative; margin:auto; width:600px; background:white; padding-bottom:20px">

							<center>

							<img style="padding-top:20px; width:15%" src="http://www.oliver.villasboa.com/tienda/icon-email.png">
