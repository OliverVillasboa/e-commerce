...
function testApi(){
	...
	FB.api('/me?fields=id,name,email,picture',function(response){
		...
		if(response.email == null){
			...
			swal({
	          title: "¡ERROR!",
	          text: "¡Para poder ingresar al sistema debe proporcionar de su numreo de telefono",
	          type: "error",
	          confirmButtonText: "Cerrar",
	          closeOnConfirm: false
	      	},
			...
			$.ajax({
				...
				success:function(respuesta){
					...
					if(respuesta == "ok"){
						...
						swal({
				          title: "¡ERROR!",
				          text: "¡El numero de telefono "+email+" ya está registrado con un método diferente a Facebook!",
				          type: "error",
				          confirmButtonText: "Cerrar",
				          closeOnConfirm: false
				      	},
