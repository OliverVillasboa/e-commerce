			...
			<div class="panel-body cuerpoCarrito">
				...
				<div clas="row itemCarrito">
					...
					<div class="col-md-2 col-sm-1 col-xs-12">
						...
						<p class="precioCarritoCompra text-center">Gs.<span>10</span></p>
				...
				<div clas="row itemCarrito">
					...
					<div class="col-md-2 col-sm-1 col-xs-12">
						...
						<p class="precioCarritoCompra text-center">Gs.<span>11</span></p>
